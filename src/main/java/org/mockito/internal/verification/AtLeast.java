...
import static org.mockito.internal.verification.checkers.AtLeastXNumberOfInvocationsChecker.checkAtLeastNumberOfCompletedInvocations;
...
public class AtLeast implements VerificationInOrderMode, VerificationMode, VerificationCompletionMode {
    ...
    public void verifyCompletion(VerificationData data) {
        ...
        checkAtLeastNumberOfCompletedInvocations(data.getAllInvocations(), data.getTarget(), wantedCount);
    }
